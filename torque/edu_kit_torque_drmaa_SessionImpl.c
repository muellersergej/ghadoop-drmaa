...
#include "drmaa.h"
#include "edu_kit_torque_drmaa_SessionImpl.h"

#define MSG_JDRMAA_BAD_JOB_TEMPLATE "Requested job template does not exist"
#define MSG_JDRMAA_NULL_POINTER_S "The %s may not be null"
  ...
  (JNIEnv *env, jobject object, jstring jobId, jlong timeout)
{
   ...
   clazz = (*env)->FindClass (env, "edu/kit/torque/drmaa/JobInfoImpl");
